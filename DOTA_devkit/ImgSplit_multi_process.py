            ...
            for obj in objects:
                ...
                if (half_iou == 1):
                    ...
                    if (len(out_poly) == 5):
                        ...
                        """
                        continue
                    if (self.choosebestpoint):  # here is to select pts set via minest pts distance
...
if __name__ == '__main__':
    split = splitbase(r'../DOTA/train', r'../DOTA/split_test_dir/train_split',
                      gap=200, subsize=1024, num_process=1)
    split.splitdata(1)

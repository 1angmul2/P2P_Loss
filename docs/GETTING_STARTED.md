...
Assume that you have already downloaded the checkpoints to `work_dirs/retinanet_p2p_cv/retinanet_p2p_cv.pth`.

* Test P2P Loss on DOTA.

```shell
python tools/test.py configs/p2p_loss/p2p_loss/cv/retinanet_p2p_cv.py \
    work_dirs/retinanet_p2p_cv/retinanet_p2p_cv.pth \ 
    --out work_dirs/retinanet_p2p_cv/res.pkl
```

* Test P2P Loss with 4 GPUs.

```shell
./tools/dist_test.sh configs/p2p_loss/p2p_loss/cv/retinanet_p2p_cv.py \
    work_dirs/retinanet_p2p_cv/retinanet_p2p_cv.pth 4 \ 
    --out work_dirs/retinanet_p2p_cv/res.pkl
```

*If you want to evaluate the result on DOTA test-dev, zip the files in ```work_dirs/retinanet_p2p_cv/result_after_nms``` and submit it to the  [evaluation server](https://captain-whu.github.io/DOTA/index.html).

...
test_cfg = dict(
    ...
    min_bbox_size=0,
    score_thr=0.05,
    nms=dict(type='nms_rotated', iou_thr=0.1, one_cls=False),
    max_per_img=2000)
# dataset settings
dataset_type = 'DotaDataset'
data_root = 'data/DOTA/dota_ms05_10_15/'
img_norm_cfg = dict(
...
albu_train_transforms = [
    ...
    dict(
        ...
        p=0.1),
    dict(type='JpegCompression', quality_lower=85, quality_upper=99, p=0.1),
...
train_pipeline = [
    ...
    dict(type='RandomRotate', rate=0.5,
